...
function encode() {
	...
	var args = "-qscale 2 -r "+project.fps+" -b 4Mb -i " + audio +  " -i "+stills_dir+"%d.png "+target;
...
function RenderProject(options) {
	...
	if (!this.width) this.width = 720; // 720 | 1920| 1280
	if (!this.height) this.height = 480; // 480 | 1080 | 720
